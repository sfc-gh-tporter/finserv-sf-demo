...
create or replace TABLE DIM_ACCOUNT_TYPE (
	ACCOUNT_TYPE_ID NUMBER(38,0),
...
create or replace TABLE DIM_TRANSACTION_CATEGORY (
	TRANSACTION_CATEGORY_ID NUMBER(38,0),
